            ...
            <AnimatePresence>
                {
                    selectedMessageID === message.id && messageIsForCurrentUser && (
                        <motion.div initial={{
                            ...
                            <button className={`px-2 h-full border border-e-transparent bg-white flex items-center ${message.replyTo && replayMessage ? "rounded-bl-xl border-t-transparent" : "rounded-l-xl"}`}
